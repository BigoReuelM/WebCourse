...
(6, 'jsp', 'adwadadawdadad', 'adwawadawdawda', 'afwafwawfawwfawf', 'aafawfawfawf', 2),
(7, 'php', 'PHP', 'ahdiahwidaw', 'kjabdhiagwiudgauwdg', 'aidhiwagdiaugiwd', 2),
(8, 'nodejs', 'node', 'node ito', 'basta kasjy kanu', 'kastoy ngarod kanu', 2);
